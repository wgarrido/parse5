...
const CHARACTER_REFERENCE_IN_DATA_STATE = 'CHARACTER_REFERENCE_IN_DATA_STATE';
const RCDATA_STATE = 'RCDATA_STATE';
const CHARACTER_REFERENCE_IN_RCDATA_STATE = 'CHARACTER_REFERENCE_IN_RCDATA_STATE';
...
const CHARACTER_REFERENCE_IN_ATTRIBUTE_VALUE_STATE = 'CHARACTER_REFERENCE_IN_ATTRIBUTE_VALUE_STATE';
const AFTER_ATTRIBUTE_VALUE_QUOTED_STATE = 'AFTER_ATTRIBUTE_VALUE_QUOTED_STATE';
const SELF_CLOSING_START_TAG_STATE = 'SELF_CLOSING_START_TAG_STATE';
const BOGUS_COMMENT_STATE = 'BOGUS_COMMENT_STATE';
const BOGUS_COMMENT_STATE_CONTINUATION = 'BOGUS_COMMENT_STATE_CONTINUATION';
...
_[CHARACTER_REFERENCE_IN_DATA_STATE] = function characterReferenceInDataState(cp) {
    ...
    const referencedCodePoints = this._consumeCharacterReference(cp, false);
...
_[CHARACTER_REFERENCE_IN_ATTRIBUTE_VALUE_STATE] = function characterReferenceInAttributeValueState(cp) {
    const referencedCodePoints = this._consumeCharacterReference(cp, true);
...
_[MARKUP_DECLARATION_OPEN_STATE] = function markupDeclarationOpenState(cp) {
    const dashDashMatch = this._consumeSubsequentIfMatch($$.DASH_DASH_STRING, cp, true);
    const doctypeMatch = !dashDashMatch && this._consumeSubsequentIfMatch($$.DOCTYPE_STRING, cp, false);

    const cdataMatch = !dashDashMatch && !doctypeMatch &&
                 this.allowCDATA &&
...
_[AFTER_DOCTYPE_NAME_STATE] = function afterDoctypeNameState(cp) {
    ...
    if (cp === $.GREATER_THAN_SIGN) {
        ...
        const publicMatch = this._consumeSubsequentIfMatch($$.PUBLIC_STRING, cp, false);
        const systemMatch = !publicMatch && this._consumeSubsequentIfMatch($$.SYSTEM_STRING, cp, false);
...
_[CDATA_SECTION_STATE] = function cdataSectionState(cp) {
    while (true) {
        if (cp === $.EOF) {
            ...
            const cdataEndMatch = this._consumeSubsequentIfMatch($$.CDATA_END_STRING, cp, true);
