...
export function assign(tokenizer) {
    ...
    const tokenizerProto = Object.getPrototypeOf(tokenizer);

    let tokenStartOffset = -1;
    let tokenCol = -1;
    let tokenLine = 1;
    let isEol = false;
    let lineStartPos = 0;
    ...
    tokenizer._consume = function () {
        const cp = tokenizerProto._consume.call(this);
    ...
    Object.keys(tokenizerProto.MODE)
        ...
        .map(modeName => tokenizerProto.MODE[modeName])
